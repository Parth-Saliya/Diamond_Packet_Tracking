...
namespace Packet_Tracking {
    ...
    public partial class packetDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/packetDataSet1.xsd";
        ...
        public partial class userTbDataTable : global::System.Data.TypedTableBase<userTbRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userTbRow AdduserTbRow(int Id, string Name, string Department) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userTbRow FindById(int Id) {
        ...
        public partial class userTbRow : global::System.Data.DataRow {
            ...
            public int Id {
                get {
                    return ((int)(this[this.tableuserTb.IdColumn]));
                }
                set {
                    this[this.tableuserTb.IdColumn] = value;
                }
            }
...
namespace Packet_Tracking.packetDataSetTableAdapters {
    ...
    public partial class userTbTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[userTb] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AN" +
                "D [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Department = 1 AND" +
                " [Department] IS NULL) OR ([Department] = @Original_Department)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[userTb] ([Id], [Name], [Department]) VALUES (@Id, @Name, @Depa" +
                "rtment);\r\nSELECT Id, Name, Department FROM userTb WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[userTb] SET [Id] = @Id, [Name] = @Name, [Department] = @Department WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Department = 1 AND [Department] IS NULL) OR ([Department] = @Original_Department)));
SELECT Id, Name, Department FROM userTb WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Department FROM dbo.userTb";
        ...
        public virtual int Fill(packetDataSet.userTbDataTable dataTable) {
        ...
        public virtual packetDataSet.userTbDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            packetDataSet.userTbDataTable dataTable = new packetDataSet.userTbDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(packetDataSet.userTbDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Department) {
        ...
        public virtual int Insert(int Id, string Name, string Department) {
        ...
        public virtual int Update(int Id, string Name, string Department, int Original_Id, string Original_Name, string Original_Department) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Department, int Original_Id, string Original_Name, string Original_Department) {
            return this.Update(Original_Id, Name, Department, Original_Id, Original_Name, Original_Department);
        }
    }
